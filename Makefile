...
ifeq ($(findstring --network sepolia,$(ARGS)),--network sepolia)
	NETWORK_ARGS := --rpc-url $(SEPOLIA_RPC_URL) --account metamask --sender 0xd2ab3db7f90dd7afeda86755c8fd0f2fcbcfe64c --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
endif
